...
formatter.match({
  "location": "CadastroDeClienteSteps.que_esteja_na_tela_de_início()"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "CadastroDeClienteSteps.informo_o_dados(String,String,String,String,String,String,String,String,String,String,String)"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "CadastroDeClienteSteps.seleciono_salvar()"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "CadastroDeClienteSteps.retorna_msg_de_sucesso()"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "ExportacaoDadosSteps.que_esteja_na_tela_de_exportar_dados()"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "ExportacaoDadosSteps.seleciono(String)"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "ExportacaoDadosSteps.retorna_de_exportação_com_sucesso(String)"
});
formatter.result({
  "status": "passed"
});
